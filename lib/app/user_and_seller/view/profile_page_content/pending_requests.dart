                              ...
                              child: Column(children: <Widget>[
                                ...
                                ListTile(
                                  ...
                                  trailing: GestureDetector(
                                      onTap: () => showTextDialog(context, title: "Change Timeslot", value: request.timeslot, id: "time", rid: request.rid, seller: request.seller),
                                ...
                                ListTile(
                                  ...
                                  trailing: GestureDetector(
                                      onTap: () => showTextDialog(context, title: "Change Date", value: request.date, id: "date", rid: request.rid, seller: request.seller),
                                      child: Icon(Icons.edit)),
                                ),
                                Row(
                                  ...
                                  children: [
                                    ElevatedButton(
                                        onPressed: () {
                                          launch(context, RepairRequestAccept.routeName,[
                                            request.user,
                                            request.seller,
                                            request.service,
                                            request.rid,
                                    ...
                                    ElevatedButton(
                                        onPressed: () {
                                          UserController.rejectRepair(request.rid);
                                          Navigator.of(context).pushReplacementNamed(ProfilePageSeller.routeName, arguments: request.seller);
                                        },
                                        child: Text(
                                          "Reject",
                                          style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),
