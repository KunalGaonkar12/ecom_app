                              ...
                              child: Card(
                                child: Column(children: <Widget>[
                                  ListTile(
                                    ...
                                    leading: Icon(
                                      Icons.add_box, color: AppColor.primary,
                                    ),
                                  ),
                                  ListTile(
                                  ...
                                  ListTile(
                                    title: Text("Product Name: ${request.productName}"),
                                  ),
                                  ListTile(
                                    title: Text("User: ${request.user}"),
                                  ),
                                  ListTile(
                                    title: Text("User Phone: ${request.userPhone}"),
                                  ),
                                  ListTile(
                                    title: Text("Seller Phone: ${request.sellerPhone}"),
                                  ),
                                  ListTile(
                                    title: Text("Shop Address: ${request.shopAddress}"),
                                  ),
                                  ListTile(
                                    title: Text("User Address: ${request.userAddress}"),
                                  ),
                                  MaterialButton(
                                    color: AppColor.primary,
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                                    onPressed: () => showMessageDialog(context, from: email, to: request.user),
