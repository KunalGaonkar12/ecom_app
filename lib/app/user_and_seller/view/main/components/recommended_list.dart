        ...
        SizedBox(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Center(child: Text('Recommended', style: TextStyle(color: darkGrey, fontSize: 16.0, fontWeight: FontWeight.bold))),
            ],
          ),
        ),
        Flexible(
                      ...
                      children: (snapshot.data! as List<Products>)
                          .map(
                            (product) => ClipRRect(
                              ...
                              child: InkWell(
                                onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => ProductPage(email, product: product))),
                                child: Container(
