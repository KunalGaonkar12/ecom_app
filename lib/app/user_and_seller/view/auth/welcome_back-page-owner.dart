...
class _WelcomeBackPageOwnerState extends State<WelcomeBackPageOwner> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget loginButton = Positioned(
      ...
      child: InkWell(
        onTap: () async {
          await UserAuthController.userOwnerLogin(email: email.text,
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[Spacer(flex: 3), welcomeBack, Spacer(), subTitle, Spacer(flex: 2), loginForm, Spacer(flex: 2), forgotPassword],
            ),
          )
        ],
      ),
