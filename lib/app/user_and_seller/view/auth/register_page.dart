...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget registerButton = Positioned(
      ...
      child: InkWell(
        onTap: () async {
          await UserAuthController.RegisterUser(email: email.text,
          password: password.text,
          code: code.text).then((value) {
            email.clear();
            password.clear();
            code.clear();
          });
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    controller: code,
                    keyboardType: TextInputType.text,
                    decoration: buildInputDecoration(Icons.text_fields, "Refferal Code"),
                    validator: (String? value) {
                      if (value!.length != 6) {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                registerForm,
                Spacer(flex: 2),
                Padding(padding: EdgeInsets.only(bottom: 10), child: socialRegister)
              ],
            ),
          ),
          Positioned(
