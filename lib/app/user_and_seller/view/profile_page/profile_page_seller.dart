...
import '../profile_page_content/showMessageSeller.dart';
            ...
            child: Column(
              children: <Widget>[
                ...
                ListTile(
                  ...
                  onTap: () =>
                      launch(context, ThirdPartyDeliveryService.routeName, email),
                ),
                Divider(),
                ListTile(
                  title: Text('Messages'),
                  ...
                  onTap: () =>
                      launch(context, ShowMessagesSeller.routeName, email),
                ),
                Divider(),
                ListTile(
                  title: Text('Settings'),
